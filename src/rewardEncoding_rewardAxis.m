...
outputFolder = "../results/202307w1-all/neuralData_GoCue/projection-2D/"; makeDir(outputFolder); 
outputFolderProjection = "../results/202307w1-all/neuralData_GoCue/rewardAxis-projection/"; makeDir(outputFolderProjection);
outputFolderStretching = "../results/202307w1-all/neuralData_GoCue/stretching/"; makeDir(outputFolderStretching);
...
%         scatter([1 ntimeBin], [PSTH(1) PSTH(ntimeBin)], 100, rewColors(rewards(i), :), 'filled');
%     end
% end
% xlabel("Time (ms)");
